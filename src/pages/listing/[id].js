...
export default function ListingDetail() {
  ...
  const handleContactSeller = async () => {
    ...
    if (user._id === listing.seller._id) {
      alert("You cannot chat with yourself as you are the seller of this listing.")
      return
    }
      ...
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="container mx-auto px-4">
            ...
            <nav className="flex" aria-label="Breadcrumb">
              <ol className="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                  <div className="flex items-center">
                    <span className="mx-2 text-gray-400">/</span>
                    <span className="text-sm font-medium text-gray-500 truncate max-w-xs">{listing.title}</span>
                  </div>
                </li>
              </ol>
            </nav>
                    ...
                    {listing.images.map((image, index) => (
                      <div
                        ...
                        className={`relative w-20 h-20 flex-shrink-0 mr-2 cursor-pointer rounded-md overflow-hidden ${
                          activeImageIndex === index ? "ring-2 ring-green-500" : "opacity-70"
                        }`}
                      >
                        <Image
              ...
              <div className="bg-white rounded-lg shadow-md p-6 mt-6">
                ...
                <div className="flex flex-wrap gap-4 mb-6">
                  <div className="flex items-center bg-gray-100 px-3 py-1 rounded-full">
                    ...
                    <span className="text-sm">Posted {new Date(listing.createdAt).toLocaleDateString()}</span>
                  </div>
                  <div className="flex items-center bg-gray-100 px-3 py-1 rounded-full">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                <div className="flex justify-between items-center mb-4">
                  <span className="text-3xl font-bold text-green-600">Rs. {listing.price.toLocaleString()}</span>
                  <div className="flex gap-2">
                    <button
                      onClick={handleFavoriteToggle}
                      className={`p-2 rounded-full ${
                        isFavorite ? "bg-red-100 text-red-500" : "bg-gray-100 text-gray-500 hover:text-red-500"
                      }`}
          ...
          <div className="mt-12">
            ...
            <RelatedListings currentListingId={listing._id} category={listing.category} />
          </div>
        </div>
      </div>
    </>
